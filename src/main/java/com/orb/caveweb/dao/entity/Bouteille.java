...
public class Bouteille {
    ...
    @Column(name = "id_producteur", updatable = false, insertable = false)
    ...
    public Bouteille(Integer id, String nom, Integer idProducteur, String couleur, String cru, String appelation, String region, String pays, Double taille, Double prixAchat, Double prixActuelle, Integer dateDeProduction, Integer dateGarder, String image, Integer idUtilisateur, String commentaire, Integer nbrListCourses, Integer evaluation, String urlAchat, Boolean isAllowedCl) {
        this.id = id;
        this.nom = nom;
